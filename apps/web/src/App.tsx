...
function RequireLecturer({ children }: { children: JSX.Element }) {
  return getRole() === 'lecturer'
    ? children
    : <Navigate to="/lecturer-login" replace />
}
  ...
  return (
    <Routes>
      ...
      <Route path="/lecturer-login" element={
        <RedirectIfAuthed><LecturerLoginPage /></RedirectIfAuthed>
      } />
      <Route path="/lecturer-signup" element={
        <RedirectIfAuthed><LecturerSignupPage /></RedirectIfAuthed>
      } />
      <Route path="/student-login" element={
        <RedirectIfAuthed><StudentLoginPage /></RedirectIfAuthed>
      } />
      <Route path="/student-signup" element={
        <RedirectIfAuthed><StudentSignupPage /></RedirectIfAuthed>
      } />

      {/* protected student area */}
      <Route path="/student" element={
        <RequireStudent><StudentPage /></RequireStudent>
      } />
      <Route path="/join" element={
        <RequireStudent><JoinPage /></RequireStudent>
      } />

      {/* protected lecturer area */}
      <Route path="/dashboard" element={
        <RequireLecturer><AdminPage /></RequireLecturer>
      } />
      <Route path="/stats/:id" element={
        <RequireLecturer><StatsPage /></RequireLecturer>
      } />
